...
public class QuickAction extends CustomPopupWindow implements OnDismissListener {
	...
	public void setRootViewId(int id) {
		...
		mTrack 		= (ViewGroup) mRootView.findViewById(R.id.scroll);
	...
	public void show (View anchor) {
		...
		Log.d("Pritz", "location[0] "+location[0]+" location[1] "+location[1]+" anchor.getWidth() "+anchor.getWidth()+" anchor.getHeight() "+anchor.getHeight());
		...
		Log.d("DabKick", "screenwidth " + screenWidth);
